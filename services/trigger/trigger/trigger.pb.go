...
var file_trigger_proto_rawDesc = []byte{
	...
	,
...
var file_trigger_proto_goTypes = []interface{}{
	(*TestRequest)(nil), // 0: trigger.TestRequest
	(*TestReply)(nil),   // 1: trigger.TestReply
}
var file_trigger_proto_depIdxs = []int32{
	0, // 0: trigger.Trigger.Test:input_type -> trigger.TestRequest
	1, // 1: trigger.Trigger.Test:output_type -> trigger.TestReply
...
func (c *triggerClient) Test(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, "/trigger.Trigger/Test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedTriggerServer) Test(context.Context, *TestRequest) (*TestReply, error) {
...
func _Trigger_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TriggerServer).Test(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trigger.Trigger/Test",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TriggerServer).Test(ctx, req.(*TestRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Trigger_serviceDesc = grpc.ServiceDesc{
	ServiceName: "trigger.Trigger",
	HandlerType: (*TriggerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Test",
			Handler:    _Trigger_Test_Handler,
		},
	},
